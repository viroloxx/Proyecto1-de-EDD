...
public class GestionCiudad extends javax.swing.JFrame {
    ...
    private void initComponents() {
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(addRuta, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(63, 63, 63)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(saveCiudades, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void saveCiudadesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_saveCiudadesActionPerformed
        ...
        Grafo grafo = VentanaOpcion.grafo;
        String ciudadOr = (String) origen.getSelectedItem();
        String ciudadDest = (String) Destino.getSelectedItem();

        if(!ciudadOr.equalsIgnoreCase(ciudadDest)){
            ...
            if(numero){// confirma que sea un número
                ...
                if(Integer.parseInt(distancia.getText())>0){
                    ...
                    Ciudad ciudadD = grafo.BuscarCiudad(ciudadDest).getData();
                    Ruta rutaNueva = new Ruta(ciudadOr, ciudadDest,Integer.parseInt(distancia.getText()));

                    if(!grafo.adyacente(ciudadOr, ciudadDest)){ // Confirma que la ruta no exista para agregarla, si si existe, no la agrega y 
                                                                   // lanza un mensaje
    ...
    JOptionPane.showMessageDialog(null, "Debe ser una ruta a una ciudad diferente");
